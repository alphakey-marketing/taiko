...
const FLAG_LABELS: Record<string, string> = {
  ...
  // Samurai path flags
  flag_samurai_path_loyalty: '忠義の武士道',
  flag_samurai_path_self: '己の剣道',
  flag_sword_vow: '武士の誓いを立てた',
  flag_guard_done: '城門の警護を務めた',
  flag_mentor_teaching: '師父の秘伝を授かった',
  flag_rival_ally: '朧と真の同志になった',
  flag_rival_bond: '朧との絆が生まれた',
  flag_sword_pilgrim_done: '剣の巡礼を達した',
  flag_samurai_war_volunteer: '戦に志願した',
  flag_rival_story_heard: '朧の過去を聞いた',
  flag_samurai_serve_lord: '主君への忠義を選んだ',
  flag_samurai_independent: '独立剣客の道を選んだ',
  // Merchant path flags
  flag_path_revenge_commerce: '復讐の商才',
  flag_path_new_self: '誇りある再出発',
  flag_debt_paid_early: '早期返済した',
  flag_debt_negotiated: '借金交渉に成功した',
  flag_debt_cleared: '家の借金を清算した',
  flag_commerce_won: '商売競争に勝った',
  flag_merchant_ally: '商人同盟を結んだ',
  flag_supply_contract: '軍需供給契約を結んだ',
  flag_market_influence: '市場に影響力を持つ',
  flag_guild_member: '商人組合に入った',
  flag_port_invested: '港商品に投資した',
  flag_sea_trade_route: '海外交易路を開いた',
  flag_merchant_stronghold: '城下商圏を確立した',
}
